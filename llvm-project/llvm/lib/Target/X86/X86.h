...
/// This pass implements Linux Kprobe Optimization for instructions not already
/// handled by kprobe jump optimization.
FunctionPass *createX86KprobeOptPass();
...
void initializeX86KprobeOptPass(PassRegistry &);
