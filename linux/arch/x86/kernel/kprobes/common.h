...
extern void do_nop_opt(struct kprobe *p);
extern void undo_nop_opt(struct kprobe *p);
#else /* !CONFIG_KPROBES_NOP_OPT */
static void __always_inline do_nop_opt(struct kprobe *p) { }
static void __always_inline undo_nop_opt(struct kprobe *p) { }
